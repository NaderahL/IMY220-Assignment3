...
const handler = new EventHandler(events);
//console.log(handler.getEventsBetweenDates("2022/02/01", "2022/05/15"));
//console.log(handler.getByMonth(05));
//console.log(handler.getUniqueDateAndSort());
//console.log(handler.getSummary());
//console.log(handler.getSummary({name: "University expo", description: "Expo to showcase University degrees", dateStart: "2022/02/01", dateEnd: "2022/02/14"},{name: "Market", description: "Farmer's market day long event", dateStart: "2022/06/12", dateEnd: "2022/06/12"}));
